// SPDX-License-Identifier: MIT  0.000090141192631284  0.000117414064148517     
//https://bscscan.com/address/0x05ac1137b19c1dadd93c6df7fefc52ff090f40e9
//https://bscscan.com/address/0x25D81D1c7Cce53A27c21f94c1aE859Ed8cCdA58F#writeContract
...
contract CHRONODAO is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 public totalFee = liquidityFee.add(marketingFee).add(firePitFee);
    uint256 public sellFeel = 10;
    uint256 public sellFeet = 10;
    uint256 public sellFeef = 10;
    uint256 public feeDenominator = 1000;
    uint256 public rewardYield = 1500000;
    ...
    constructor(
        ...
        address _firePit
    ) ERC20Detailed("CHRONODAO", "CHRD", uint8(DECIMALS)) {
    ...
    function takeFee(address sender, address recipient, uint256 gonAmount) internal returns (uint256) {
        ...
        if(recipient == pair)
        {
            _totalFee = totalFee.add(sellFeet).add(sellFeef).add(sellFeel);
